            ...
            >
              {
                ...
                >
                  <Text style={{ color: 'black', fontSize: 15}} onPress={this.showDatePicker}>
                    { (value && I18n.strftime(value, '%d %b')) || 'Date' }
                  </Text>
                </TouchableOpacity>
            }
              {
              ...
              >
                <Text style={{ color: 'black', fontSize: 15}} onPress={this.showTimePicker}>
