    ...
    return (
      <View>
        <View style={{ marginLeft: 20, paddingHorizontal: 0, paddingVertical: 0 }}>
          <TextInput onChangeText={ EnteredValue => this.ShowMaxAlert(EnteredValue) } maxLength={140} numberOfLines={3} style={{ color:'black', fontWeight: '500', fontSize: 17 }}>{attributes.label}</TextInput>
        </View>
