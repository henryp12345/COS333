...
def event(request):
    if request.method == 'GET':
        ...
        e1 = Event(title = formData["title"], desc = formData["desc"], location = formData["location"], startDate = formData["startdate"], endTime = formData["enddate"], capacity = formData["capacity"], numberJoined = 0, tags = "", host = "")
        e1.save()
